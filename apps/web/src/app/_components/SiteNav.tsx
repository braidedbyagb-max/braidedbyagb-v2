...
// Shared nav for inner pages (services, policies, review, shop, booking, etc.)
// Uses page links instead of homepage anchor links
  ...
  return (
    <header className="sp-nav" id="site-header">
      ...
      <div className={`sp-mobile-menu${open ? ' open' : ''}`}>
        ...
        <Link href="/policies" onClick={close}>Policy</Link>
